...
<SPConfig  xmlns="urn:mace:shibboleth:3.0:native:sp:config"
    ...
    <ApplicationDefaults entityID="https://example/shibboleth"
        homeURL="https://example/Shibboleth.sso/Session"
       ...
       <Sessions lifetime="28800" timeout="3600" relayState="ss:mem"
        ...
        <CredentialResolver type="File" use="signing"
            key="/etc/letsencrypt/live/example/privkey.pem" certifica>        <!-- <CredentialResolver type="File" use="encryption"
...
Add this:
```js
this.returnWhiteList = [ "^https:\/\/exampl\.ma.bw-cloud-instance\.org\/Shibboleth\.sso\/>
```