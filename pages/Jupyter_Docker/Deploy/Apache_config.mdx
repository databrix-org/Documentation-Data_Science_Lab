...
3. [Apache Konfiguration für Vermeidung CORS Error in Browser](https://discourse.jupyter.org/t/jupyterhub-try-to-make-preflight-request-to-shibboleth-idp/24853/4)
4. [Apache Konfiguration für bypassing Shibboleth Authentification](https://shibboleth.atlassian.net/wiki/spaces/SHIB2/pages/2577072327/NativeSPApacheConfig#NativeSPApacheConfig-AuthConfigOptions)
5. [Apache Konfiguration für jupyter-collaboration extension](https://discourse.jupyter.org/t/cant-connect-to-kernel/24705/14)
3. [Anleitung für Installation Apache mit Shibboleth](https://github.com/ConsortiumGARR/idem-tutorials/blob/master/idem-fedops/HOWTO-Shibboleth/Service%20Provider/Debian/HOWTO%20Install%20and%20Configure%20a%20Shibboleth%20SP%20v3.x%20on%20Debian-Ubuntu%20Linux.md)