...
services:
  ...
  apache2:
    ...
    volumes:
      ...
      - "/etc/letsencrypt/live/example.org/fullchain.pem:/etc/letsencrypt>      - "/etc/letsencrypt/live/93eca700-b764-4621-ab7f-de0792aa31ab.ma.bw-cloud-instance.org/privkey.pem:/etc/letsencrypt/l>     #- "/etc/hosts:/etc/hosts"
